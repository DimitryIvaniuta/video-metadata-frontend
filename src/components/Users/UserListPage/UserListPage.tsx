            ...
            <div className="overflow-x-auto bg-white shadow rounded-lg">
                <table className="min-w-full table-auto">
                    ...
                    <tr>
                        ...
                        >
                            Username {sortBy === UserSort.Username && (sortDesc ? '↓' : '↑')}
                        </th>
                        <th
                            className="px-4 py-2 cursor-pointer select-none"
                        ...
                        >
                            Created {sortBy === UserSort.CreatedAt && (sortDesc ? '↓' : '↑')}
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    {!loading && !error && items.filter(u=>u!==null && u!==undefined)
                        .map((user) => (
                        <tr key={user.id} className="border-t hover:bg-gray-50">
                            ...
                            <td className="px-4 py-2">
                                {user.createdAt && formatDistanceToNow(parseISO(user.createdAt), { addSuffix: true })}
                            </td>
                        </tr>
                    ))}
                    </tbody>
